...
func (Args) Kind() string { return "add_one" }

// Worker implements the add-one functionality
type Worker struct {
	river.WorkerDefaults[Args]
	logger *slog.Logger
}

// NewWorker creates a new AddOne Worker
...
func (w *Worker) Work(ctx context.Context, job *river.Job[Args]) error {
	...
	w.logger.Info("AddOneWorker processing",
		"job_id", job.ID,
		"input", input,
		"result", result,
	)
